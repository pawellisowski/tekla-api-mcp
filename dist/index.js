...
| Name | Description |
|------|-------------|
${detailed.constructors.map((ctor) => `| **${ctor.name}** | ${ctor.description} |`).join('\n')}
...
|------|-------------|-----------|
${detailed.properties.map((prop) => `| **${prop.name}** | ${prop.description} | ${prop.inherited ? `Yes (from ${prop.inheritedFrom})` : 'No'} |`).join('\n')}
...
| Name | Description | Inherited |
|------|-------------|-----------|
${detailed.methods.map((method) => `| **${method.name}** | ${method.description} | ${method.inherited ? `Yes (from ${method.inheritedFrom})` : 'No'} |`).join('\n')}
...
${detailed.examples.map((example, index) => `### Example ${index + 1}
\`\`\`csharp
${example}
\`\`\`
`).join('\n')}
